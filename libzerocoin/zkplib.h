...
inline void vectorTimesConstant(CBN_vector& kV,  CBN_vector& V, const CBigNum& k, const CBigNum& modulus)
{
...
{
    for(unsigned int i=0; i<v.size(); i++)  v[i] = randBignum(modulus);
}
