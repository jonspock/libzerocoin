...
public:
	 ...
	 */
	CommitmentProofOfKnowledge(const SerialNumberGroupParams* aParams, const IntegerGroupParams* bParams, const Commitment& a, const Commitment& b);
	template<typename Stream>
	CommitmentProofOfKnowledge(const SerialNumberGroupParams* aParams,
